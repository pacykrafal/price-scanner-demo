          ...
          <form onSubmit={handleSearch}>
            <div className="flex items-center border-b border-border px-4">
              ...
              <Input
                ...
                className="border-0 bg-transparent px-3 py-4 text-sm focus-visible:ring-0 focus-visible:ring-offset-0"
              />
            </div>
          </form>
          <div className="p-4 text-sm text-muted-foreground">
            <p>Wpisz nazwę produktu, kod SKU lub EAN, aby rozpocząć wyszukiwanie.</p>
          </div>
        </DialogContent>
      </Dialog>
    </>
